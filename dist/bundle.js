  ...
  var require_eventHandlers = __commonJS({
    "eventHandlers.js"(exports, module) {
      var EventHandlers2 = class {
        constructor(eventBinder, harpSoundControl2) {
          this.eventBinder = eventBinder;
          this.harpSoundControl = harpSoundControl2;
          this.ongoingTouches = [];
    ...
    "node_modules/tone/build/Tone.js"(exports, module) {
      !function(t, e) {
        ...
        return function(t) {
          ...
          var Pe;
          const je = /* @__PURE__ */ new WeakMap(), Le = (ze = de, class {
            constructor(t2) {
          ...
          const cn = ((t2, e2, s2, n2, i2, o2, r2) => class extends t2 {
            ...
            return v2 === void 0 ? c2.set(p2, /* @__PURE__ */ new Map([[d2, b2]])) : v2.set(d2, b2), b2.then(() => {
              const t3 = h2.get(p2);
              t3 === void 0 ? h2.set(p2, /* @__PURE__ */ new Set([d2])) : t3.add(d2);
            }).finally(() => {
              const t3 = c2.get(p2);
          ...
          const En = ((t2) => (e2, s2, n2 = 0, i2 = 0) => {
            ...
            const F2 = g2.numberOfOutputs === 0 ? [D2] : M2, I2 = { get bufferSize() {
              ...
              return b2.port2;
            }, addEventListener: (...t3) => D2.addEventListener(t3[0], t3[1], t3[2]), connect: t2.bind(null, F2), disconnect: h2.bind(null, F2), dispatchEvent: (...t3) => D2.dispatchEvent(t3[0]), removeEventListener: (...t3) => D2.removeEventListener(t3[0], t3[1], t3[2]) }, P2 = /* @__PURE__ */ new Map();
            var j2, L2;
          ...
          class Gi extends Wi {
            constructor() {
              super(), this.name = "Context", this._constants = /* @__PURE__ */ new Map(), this._timeouts = new Ni(), this._timeoutIds = 0, this._initialized = false, this.isOffline = false, this._workletModules = /* @__PURE__ */ new Map();
          ...
          class br extends Ho {
            constructor() {
              super(Di(br.getDefaults(), arguments, ["url", "onload"])), this.name = "Player", this._activeSources = /* @__PURE__ */ new Set();
          ...
          class Tr extends wo {
            constructor() {
              super(Di(Tr.getDefaults(), arguments, ["urls", "onload"], "urls")), this.name = "Players", this.input = void 0, this._players = /* @__PURE__ */ new Map();
...
`);
          ...
          class ua extends ca {
            constructor() {
              super(Di(ua.getDefaults(), arguments, ["callback", "events"])), this.name = "Part", this._state = new yo("stopped"), this._events = /* @__PURE__ */ new Set();
...
`);
          ...
          class dc extends wo {
            constructor() {
              ...
              this.input = this.output = new ko({ context: this.context }), dc._allSolos.has(this.context) || dc._allSolos.set(this.context, /* @__PURE__ */ new Set()), dc._allSolos.get(this.context).add(this), this.solo = t2.solo;
            }
            static getDefaults() {
            ...
            _addSolo() {
              dc._soloed.has(this.context) || dc._soloed.set(this.context, /* @__PURE__ */ new Set()), dc._soloed.get(this.context).add(this);
            }
            _removeSolo() {
          ...
          dc._allSolos = /* @__PURE__ */ new Map(), dc._soloed = /* @__PURE__ */ new Map();
          class fc extends wo {
            constructor() {
  ...
  // harpSoundControl.js
  var require_harpSoundControl = __commonJS({
    "harpSoundControl.js"(exports, module) {
      var Tone = require_Tone();
      var HarpSoundControl2 = class {
        constructor() {
          this.chordArray = [
        ...
        playNote = (whichString) => {
          ...
          console.log(`note to play = ${this.chordArray[whichString.chord][whichString.string]}`);
          this.sampler.triggerAttack(this.chordArray[whichString.chord][whichString.string], Tone.now());
        };
      };
      module.exports = HarpSoundControl2;
    }
  });
  ...
  var HarpSoundControl = require_harpSoundControl();
  var eventBinders = new EventBinders();
  var harpSoundControl = new HarpSoundControl();
  var eventHandlers = new EventHandlers(eventBinders, harpSoundControl);
})();
/**
 * Tone.js
 * @author Yotam Mann
